...
[GitHub Releases](https://github.com/NaturalDevCR/snap-ctrl/releases) for
per-release notes and downloadable builds.
...
2.  Create and push a tag starting with `v` (e.g., `v0.4.0`):
    ```bash
    git tag v0.4.0
